...
# display(dbutils.fs.ls(f"{presentation_folder_path}/constructor_standings"))
test = spark.read.parquet(f"{presentation_folder_path}/constructor_standings")
display(test)
# dbutils.fs.rm(f"{presentation_folder_path}/constructor_standings", recurse=True)
